...
if __name__ == '__main__':
    # midfile_to_piano_roll("../datasets/training/bach_850.mid",5)
    x = load_all_dataset("../datasets/training")
    # x = np.matrix(x[0][1:])
    # for i in x:
    #     print(i)
    #     print(i.shape)
    ...
    # print("l = ", l)
    # p = np.array([[1, 2], [3, 4]])
    # visualize_piano_roll(x[0],5)
    f = test_piano_roll(x[0],10,5)
    # visualize_piano_roll(f, 5)
    embed_play_v1(f,5)